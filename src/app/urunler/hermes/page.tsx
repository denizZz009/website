...
// Sample products data for Hermes
const hermesProducts = [
  {
    id: 51,
    name: "Hermes H Logo Tişört",
    description: "Hermes H logolu, %100 premium pamuklu erkek tişört",
    price: "₺899,00",
    ...
    <div className="min-h-screen pt-16 bg-black text-white">
      ...
      <div className="relative h-[300px] w-full overflow-hidden border-b border-white/10">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
          <h1 className="text-4xl font-bold mb-2">Hermes</h1>
          <p className="text-lg max-w-2xl">Lüks modanın sembolü Hermes, özel fiyatlarla Galerizo'da</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div className="flex items-center gap-2">
            ...
            <Badge className="bg-blue-600">{hermesProducts.length} Ürün</Badge>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 p-4 border border-white/10 rounded-md bg-black">
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center">
                    <input type="checkbox" id="category-premium" className="mr-2" />
                    <label htmlFor="category-premium" className="text-sm">Premium Tişörtler</label>
                  </div>
                  <div className="flex items-center">
              ...
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center">
                    <input type="checkbox" id="color-orange" className="mr-2" />
                    <label htmlFor="color-orange" className="text-sm">Turuncu</label>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-1">
                  <div className="flex items-center">
                    <input type="checkbox" id="price-0-500" className="mr-2" />
                    <label htmlFor="price-0-500" className="text-sm">0 - 500 TL</label>
                  </div>
                  <div className="flex items-center">
                    <input type="checkbox" id="price-500-1000" className="mr-2" />
                    <label htmlFor="price-500-1000" className="text-sm">500 - 1000 TL</label>
                  </div>
                  <div className="flex items-center">
                    <input type="checkbox" id="price-1000-1500" className="mr-2" />
                    <label htmlFor="price-1000-1500" className="text-sm">1000 - 1500 TL</label>
                  </div>
                  <div className="flex items-center">
                    <input type="checkbox" id="price-1500+" className="mr-2" />
                    <label htmlFor="price-1500+" className="text-sm">1500 TL ve üzeri</label>
                  </div>
                </div>
              </div>
            </div>
