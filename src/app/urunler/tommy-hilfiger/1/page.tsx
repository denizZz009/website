...
const product = {
  ...
  fullDescription: "Bu Tommy Hilfiger logo tişört, yumuşak ve dayanıklı %100 pamuklu kumaştan üretilmiştir. Göğüs kısmında klasik Tommy Hilfiger logosu bulunan bu tişört, günlük ve spor kombinlerinizin vazgeçilmez parçası olacak. Regular fit kesimi ile rahat bir kullanım sunar. Yıkama talimatlarına uygun kullanıldığında uzun ömürlü ve form koruyucu özelliğe sahiptir.",
  price: "₺349,00",
  originalPrice: "₺749,00",
  discount: "53%",
  images: [
    "https://images.unsplash.com/photo-1576871337622-98d48d1cf531?q=80&w=1974&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1565693413579-8a73cb8db0ea?q=80&w=1974&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1571945153237-4929e783af4a?q=80&w=1974&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1503341733017-1901578f9f1e?q=80&w=1976&auto=format&fit=crop"
  ],
  ...
  stock: 15,
  specifications: [
    { name: "Kumaş", value: "%100 Pamuk" },
    { name: "Yaka", value: "Yuvarlak Yaka" },
    { name: "Kol", value: "Kısa Kol" },
    { name: "Kalıp", value: "Regular Fit" },
      ...
      <div className="bg-gray-950 py-4 border-b border-white/10">
        <div className="container mx-auto px-4">
          <div className="flex items-center text-sm text-gray-400">
            ...
            <span className="mx-2">/</span>
            <Link href="/urunler/tommy-hilfiger" className="hover:text-white">Tommy Hilfiger</Link>
            <span className="mx-2">/</span>
                    ...
                    >
                      <span
                        className={`w-8 h-8 rounded-full border border-white/20 ${
                          ...
                          color === "Lacivert" ? "bg-blue-900" :
                          color === "Kırmızı" ? "bg-red-500" :
          ...
          <Tabs defaultValue="details">
            ...
            <TabsContent value="details" className="text-gray-400">
              <div className="prose prose-invert max-w-none">
                ...
                <p>Tommy Hilfiger markası, Amerika'nın en önemli moda markalarından biridir. 1985 yılında kurulan marka, klasik Amerikan cool stilini modernize ederek dünya çapında büyük bir başarı elde etmiştir.</p>
              </div>
            </TabsContent>
